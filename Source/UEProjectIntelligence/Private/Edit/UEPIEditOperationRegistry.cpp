...
namespace UE::ProjectIntelligence
{
	...
	FString FUEPIEditOperationRegistry::GetCatalogHash() const
	{
		...
		{
			Canonical += FString::Printf(TEXT("%s|%s|%s|%s|%s|%d|%d\n"), *Item.Name, *Item.Domain, *Item.Risk, *Item.RollbackMode, *Item.ValidationMode, Item.bRequiresSave ? 1 : 0, Item.bAtomicSupported ? 1 : 0);
		}
