...
namespace UE::ProjectIntelligence
{
	...
	public:
		...
		static bool SetPropertyPath(UObject* Object, const FString& PropertyPath, const TSharedPtr<FJsonValue>& Value, TSharedPtr<FJsonValue>& OutBefore, TSharedPtr<FJsonValue>& OutAfter, FString& OutError);
	};
}
